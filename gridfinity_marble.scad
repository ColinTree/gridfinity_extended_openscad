...
// 最小片段角度（片段数 = 360/fa），越小片段越多 / minimum angle for a fragment (fragments = 360/fa).  Low is more fragments
fa = 6;
// 最小片段尺寸，越小片段越多 / minimum size of a fragment.  Low is more fragments
fs = 0.1;
// 片段数量，覆盖 $fa 和 $fs / number of fragments, overrides $fa and $fs
fn = 0;
