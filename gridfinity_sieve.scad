...
// 孔顶部倒角（mm） / 45 deg chamfer added to the top of the hole (mm)
sieve_hole_chamfer = 0; //0.5
// 孔的边数 / The number of sides for the hole, when custom is selected
sieve_hole_sides = 6;
// 孔的尺寸 / The size the hole, when custom is selected
