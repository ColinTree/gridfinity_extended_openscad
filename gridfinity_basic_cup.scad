...
/* [内部分隔 / Subdivisions] */
// 隔壁厚度 / Wall thickness [bottom, top]
chamber_wall_thickness = [1.2, 1.2]; //0.1
//隔壁顶部余量 / Reduce the wall height by this amount
chamber_wall_headroom = 0;//0.1
// 隔壁顶部圆角 / Radius of the top of the chamber wall, -ve is ratio of top wall thickenss. (disabled for bent walls)
...
// 磁铁侧面通道 / Use with captive magnet for a 'refinded style' magnet
magnet_side_access = "disabled";//[disabled,left:"↰ left",right:"⬑ right"]
// 内嵌磁铁高度 / raise the magnet void inside the part for print-in-magnets
magnet_captive_height = 0; // .1
// 磁铁孔波浪纹 / add a wavy pattern to the magnet hole
...
// 隔板标签 / Enable labels on internal divider walls
