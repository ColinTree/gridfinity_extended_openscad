...
// 杯体高度 / Cup height (grid units)
cup_height = 5;
// 胶棒直径 / Glue stick diameter (mm)
stick_diameter = 30;
// 顶部缓入高度 / Easement height at top for compliance while inserting (grid units)
easement_z = 0.7; // 顶部开口略大，便于插入 / a slightly large opening at the top for compliance while inserting.
// 最小壁厚 / Minimum wall thickness (mm)
minimum_wall = 4;
