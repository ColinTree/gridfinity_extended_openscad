...
/* [胶棒收纳 / Glue Stick Cup] */
// 杯体高度（层数） / cup height in layers
cup_height = 5;
// 胶棒直径（毫米） / glue stick diameter in mm
stick_diameter = 30;
// 顶部开口略大以方便插入（层数比例） / a slightly large opening at the top for compliance while inserting.
easement_z = 0.7;
// 最小壁厚（毫米） / minimum wall thickness in mm
minimum_wall = 4;
