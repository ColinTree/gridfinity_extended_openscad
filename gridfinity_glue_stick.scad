...
stick_diameter = 30; // 胶棒直径 / diameter of the glue stick
easement_z = 0.7; // 顶部扩口高度 / a slightly large opening at the top for compliance while inserting.
minimum_wall = 4; // 最小壁厚 / minimum wall thickness
