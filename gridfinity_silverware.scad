...
// Height upper surface excluding perimeter lip. . 网格单位（7mm倍数）或mm.
height = [0, 42];

/* [Other parameters] */
// 壁厚 / Wall thickness [bottom, top], top -ve is ratio of bottom wall thickness
chamber_wall_thickness = [4, -2]; //0.1
//减少隔壁高度 / Reduce the wall height
chamber_wall_headroom = 0;//0.1
// 隔室顶部圆角 / Radius of the top of the chamber wall, -ve is ratio of top wall thickness. (disabled for bent walls)
