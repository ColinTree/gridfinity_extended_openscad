...
ear_hole_x = 182.5; // FLSUN q5 螺孔间距 / distance between existing screw holes on FLSUN q5.
...
wallThickness = 0.2; // 延伸嵌入墙体以适配转角 / Extend and imbed in to wall to fit around corner
