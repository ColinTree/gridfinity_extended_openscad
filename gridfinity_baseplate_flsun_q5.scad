...
ear_hole_x = 182.5; // FLSUN Q5现有螺孔间距 / distance between existing screw holes on FLSUN q5.
ear_hole_y = 7; // 螺孔距前面板的距离 / distance of screw hole from the front panel.
cube_z = 4.4; // 从上方测量的高度 / ht from above.
M4_d = 4.2; // M4螺栓所需直径 / diameter needed for an M4 bolt.

wallThickness = 0.2; // 嵌入墙壁以适配转角 / Extend and imbed in to wall to fit around corner
