...
// 耳孔X间距 / distance between existing screw holes on FLSUN q5.
ear_hole_x = 182.5;
// 耳孔距前面板距离 / distance of screw hole from the front panel.
ear_hole_y = 7;
// 方块高度 / height from above.
cube_z = 4.4;
// M4螺栓孔径 / diameter needed for an M4 bolt.
M4_d = 4.2;

// 墙厚延伸 / Extend and imbed in to wall to fit around corner
wallThickness = 0.2;
