...
/* [FLSUN Q5底板 / FLSUN Q5 Baseplate] */
// FLSUN Q5安装孔间距（毫米） / distance between existing screw holes on FLSUN q5.
ear_hole_x = 182.5;
// 安装孔距前面板距离（毫米） / distance of screw hole from the front panel.
ear_hole_y = 7;
// 底板高度（毫米） / height from above.
cube_z = 4.4;
// M4螺栓孔直径（毫米） / diameter needed for an M4 bolt.
M4_d = 4.2;

// 延伸嵌入墙体以适配转角 / Extend and imbed in to wall to fit around corner
wallThickness = 0.2;
