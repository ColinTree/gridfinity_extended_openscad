...
// FLSUN Q5螺孔X间距 / distance between existing screw holes on FLSUN q5.
ear_hole_x = 182.5;
// 螺孔到前面板距离 / distance of screw hole from the front panel.
ear_hole_y = 7;
// 底板高度 / ht from above.
cube_z = 4.4;
// M4螺栓直径 / diameter needed for an M4 bolt.
M4_d = 4.2;
// 壁延伸量 / Extend and imbed in to wall to fit around corner
wallThickness = 0.2;
