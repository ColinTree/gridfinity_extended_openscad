...
ear_hole_x = 182.5; // 安装孔间距 / distance between existing screw holes on FLSUN q5.
ear_hole_y = 7; // 安装孔距前面板 / distance of screw hole from the front panel.
cube_z = 4.4; // 高度 / ht from above.
M4_d = 4.2; // M4螺栓直径 / diameter needed for an M4 bolt.

wallThickness = 0.2; // 墙体厚度 / Extend and imbed in to wall to fit around corner
