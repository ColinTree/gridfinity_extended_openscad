...
ear_hole_y = 7; // 耳孔Y偏移 / distance of screw hole from the front panel.
cube_z = 4.4; // Z轴高度 / ht from above.
M4_d = 4.2; // M4螺孔直径 / diameter needed for an M4 bolt.

wallThickness = 0.2; // 嵌入壁厚 / Extend and imbed in to wall to fit around corner
