...
// 螺丝孔间距 / distance between existing screw holes on FLSUN q5.
ear_hole_x = 182.5;
// 螺丝孔到前面板距离 / distance of screw hole from the front panel.
ear_hole_y = 7;
// Z轴高度 / height from above.
cube_z = 4.4;
// M4螺丝孔直径 / diameter needed for an M4 bolt.
M4_d = 4.2;

// 墙体延伸嵌入量 / Extend and imbed in to wall to fit around corner
wallThickness = 0.2;
