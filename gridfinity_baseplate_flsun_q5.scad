...
ear_hole_x = 182.5; // 螺孔间距 / distance between existing screw holes on FLSUN q5.
ear_hole_y = 7; // 螺孔前面板距离 / distance of screw hole from the front panel.
cube_z = 4.4; // 总高度 / height from above.
M4_d = 4.2; // M4螺栓孔径 / diameter needed for an M4 bolt.

wallThickness = 0.2; // 墙体嵌入厚度 / extend and imbed in to wall to fit around corner
