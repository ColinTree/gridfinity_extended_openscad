...
// 耳孔间距 / Distance between existing screw holes on FLSUN q5.
ear_hole_x = 182.5;
// 耳孔前距 / Distance of screw hole from the front panel.
ear_hole_y = 7;
// 底板厚度 / Height from above.
cube_z = 4.4;
// M4孔径 / Diameter needed for an M4 bolt.
M4_d = 4.2;

// 壁厚 / Extend and imbed in to wall to fit around corner
wallThickness = 0.2;
