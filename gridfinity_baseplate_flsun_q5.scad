...
// 螺孔横向间距 / distance between existing screw holes on FLSUN q5.
ear_hole_x = 182.5;
// 螺孔纵向距离 / distance of screw hole from the front panel.
ear_hole_y = 7;
...
// 墙体嵌入厚度 / extend and embed into wall to fit around corner.
wallThickness = 0.2;
