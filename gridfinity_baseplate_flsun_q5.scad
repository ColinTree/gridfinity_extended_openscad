...
/* [FLSUN Q5 设置 / FLSUN Q5 Settings] */
// 螺孔间距 / distance between existing screw holes on FLSUN q5.
ear_hole_x = 182.5;
// 前面板到螺孔距离 / distance of screw hole from the front panel.
ear_hole_y = 7;
// 高度 / ht from above.
cube_z = 4.4;
// M4螺栓直径 / diameter needed for an M4 bolt.
M4_d = 4.2;
// 壁厚延伸量 / Extend and imbed in to wall to fit around corner
wallThickness = 0.2;
