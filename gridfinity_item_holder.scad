...
// 扩大孔尺寸以保证间隙 / Enlarge the holes for clearance
itemholder_hole_clearance = 0.25;
// 孔深度，覆盖预设物品深度 / Depth of hole. Limited by floor height.
itemholder_hole_depth = 0; //0.1
// 孔顶部45度倒角 / 45 deg chamfer at top of hole (mm)
itemholder_hole_chamfer = 1; //0.5

/* [Item Holder - Sample Item] */
//仅渲染样品孔 / Render just a sample of the item hole, to be used as a test print
itemholder_enable_sample = false;
//壁厚 / 样品打印壁厚 / Wall thickness of the sample print
...
// 强制多卡嵌套 / Force nesting of multi cards, This has an issue where the last item could be cropped.
...
// 圆孔直径或方孔角径 / Diameter of round hole
itemholder_hole_diameter = 5; //0.1
// 自定义形状底部圆角 / Radius of the bottom of the custom shape
...
// X和Y方向孔数 / Number of holes in x and y, 0 is dynamic
itemholder_hole_gridx = 0; //1
// Y方向孔数 / Number of holes in y dimension, 0 is dynamic, y.5, is only valid for hex.
itemholder_hole_gridy = 0; //0.5
//根据孔尺寸自动设置托盒高度 / Auto set bin height.
...
// 在隔室内居中放置孔 / Center the holes within the compartments
