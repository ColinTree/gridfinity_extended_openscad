...
// 已知电池类型 / known battery type preset
...
// 已知纽扣电池类型 / known cell battery type preset
...
// 已知卡带类型 / known cartridge type preset
