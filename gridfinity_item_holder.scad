...
// 启用不规则分隔（竖向） / Enable irregular subdivisions
vertical_irregular_subdivisions = false;
// 竖向分隔位置（格为单位，从左端） / Separator positions are defined in terms of grid units from the left end
vertical_separator_config = "10.5|21|42|50|60";
// 启用不规则分隔（横向） / Enable irregular subdivisions
horizontal_irregular_subdivisions = false;
// 横向分隔位置（格为单位，从左端） / Separator positions are defined in terms of grid units from the left end
