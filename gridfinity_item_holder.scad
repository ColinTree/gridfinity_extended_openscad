...
// 启用不规则纵向分隔 / Enable irregular subdivisions
vertical_irregular_subdivisions = false;
// 分隔位置（从左端起的网格单位）/ Separator positions are defined in terms of grid units from the left end
vertical_separator_config = "10.5|21|42|50|60";
// 启用不规则横向分隔 / Enable irregular subdivisions
horizontal_irregular_subdivisions = false;
// 分隔位置（从前端起的网格单位）/ Separator positions are defined in terms of grid units from the left end
